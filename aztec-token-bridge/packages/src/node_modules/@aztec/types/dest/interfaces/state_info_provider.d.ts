import { ARCHIVE_HEIGHT, CONTRACT_TREE_HEIGHT, Fr, L1_TO_L2_MSG_TREE_HEIGHT, NOTE_HASH_TREE_HEIGHT, NULLIFIER_TREE_HEIGHT, PUBLIC_DATA_TREE_HEIGHT } from '@aztec/circuits.js';
...
export interface StateInfoProvider {
     ...
     */
    getContractSiblingPath(blockNumber: BlockNumber, leafIndex: bigint): Promise<SiblingPath<typeof CONTRACT_TREE_HEIGHT>>;
    /**
     ...
     * TODO: https://github.com/AztecProtocol/aztec-packages/issues/3414
     */
    getNullifierTreeSiblingPath(blockNumber: BlockNumber, leafIndex: bigint): Promise<SiblingPath<typeof NULLIFIER_TREE_HEIGHT>>;
    /**
     ...
     * TODO: https://github.com/AztecProtocol/aztec-packages/issues/3414
     */
    getPublicDataTreeSiblingPath(blockNumber: BlockNumber, leafIndex: bigint): Promise<SiblingPath<typeof PUBLIC_DATA_TREE_HEIGHT>>;
    /**
...
export {};
//# sourceMappingURL=state_info_provider.d.ts.map