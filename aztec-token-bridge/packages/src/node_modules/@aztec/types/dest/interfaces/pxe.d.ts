...
import { AuthWitness, ContractData, ExtendedContractData, ExtendedNote, GetUnencryptedLogsResponse, L2Block, L2Tx, LogFilter, Tx, TxExecutionRequest, TxHash, TxReceipt } from '@aztec/types';
